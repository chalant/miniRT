...
/*   Updated: 2024/02/22 12:33:29 by ychalant         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	t_light *light, float visibility[3])
{
	...
	sray.origin[0] = hit->point[0] + 0.1f * hit->normal[0];
	sray.origin[1] = hit->point[1] + 0.1f * hit->normal[1];
	sray.origin[2] = hit->point[2] + 0.1f * hit->normal[2];
	shadow_hit.ray_origin = sray.origin;
